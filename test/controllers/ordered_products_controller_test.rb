...
class OrderedProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordered_product" do
    assert_difference('OrderedProduct.count') do
      post ordered_products_url, params: { ordered_product: { cart_id: @ordered_product.cart_id, img: @ordered_product.img, name: @ordered_product.name, price: @ordered_product.price } }
    end
  ...
  test "should update ordered_product" do
    patch ordered_product_url(@ordered_product), params: { ordered_product: { cart_id: @ordered_product.cart_id, img: @ordered_product.img, name: @ordered_product.name, price: @ordered_product.price } }
